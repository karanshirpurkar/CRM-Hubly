    ...
    return (
        <div>
            ...
            <div className="custom" style={{ display: "flex", flexDirection: "row", width: "90vw" }}>
                ...
                <div className="preview" style={{ flex: 1 }}>
                    <div className="chatbot" style={{ height: '530px', width: '376px', borderRadius: '5px', overflow: 'hidden' }}>
                        ...
                        <div className="chat-window" style={{ backgroundColor: bgColor }}>
                            <div className="message" style={{ height: "48.67px", width: "231px", display: "flex", alignItems: "center", padding: "0 30px", gap: "10px" }}>
                                <p>{greeting}</p>
                            </div>
                            <div className="message" style={{ height: "48.67px", width: "231px", display: "flex", alignItems: "center", padding: "0 30px", gap: "10px" }}>
                                <p>{prompt}</p>
                            </div>
                            <div className="form" style={{ height: "261px", width: "280px", display: "flex", flexDirection: "column", marginleft: "99px" }}>
                ...
                <div className="custom" style={{ flex: 0.3, display: 'flex', flexDirection: 'column' }}>
